...
class statusTools {
  ...
  init() {
    ...
    if (!wrapper.length) {
      this.wrapper = $('<div id="j_status_tools" style="position:absolute; top:0; right:0; max-height:200px;min-height:50px; width:200px; background:rgba(45, 67, 72, 0.8);padding: 0 5px;;"></div>');
