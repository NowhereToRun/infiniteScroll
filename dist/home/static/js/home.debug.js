...
this.showCB(this.anchorItem.index,lastScreenItem.index);if(delta<0)// 向上滚动 ⬆︎
...
function addPanel(panel){console.log(container);console.log(panel.dom);container.appendChild(panel.dom);return panel;}function showPanel(id){for(var i=0;i<container.children.length;i++){container.children[i].style.display=i===id?'block':'none';}mode=id;}//
